...
public class ApplicationDbContext : IdentityDbContext
{
    ...
    public DbSet<AnaeLogiciel.Models.Mois> Mois { get; set; } = default!;
    
    public DbSet<AnaeLogiciel.Models.Genre> Genre { get; set; } = default!;
    
    public DbSet<AnaeLogiciel.Models.Artisants> Artisants { get; set; } = default!;
    
    public DbSet<AnaeLogiciel.Models.DateRealisationActivite> DateRealisationActivite { get; set; } = default!;
    
    public DbSet<AnaeLogiciel.Models.DateRealisationSousActivite> DateRealisationSousActivite { get; set; } = default!;

    public DbSet<AnaeLogiciel.Models.VDateDebutRealisationActivite> VDateDebutRealisationActivite { get; set; } = default!;

    public DbSet<AnaeLogiciel.Models.VDateFinRealisationActivite> VDateFinRealisationActivite { get; set; } = default!;
}